...
class AddJob extends ScriptCommand {
  public function getKeysCount() {
    return 6;
  }

  /**
   * Bull's Lua script to perform job additions
   *
   * @url https://github.com/OptimalBits/bull/blob/v3.6.0/lib/commands/addJob-6.lua
   */
